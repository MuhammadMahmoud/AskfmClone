...
@endsection
@section('style')
<link rel="stylesheet" href="{{ asset("Styles/Settings/css.css") }}">
@endsection
@section('content')
<div class="container">
          ...
          <div class="card-body tab-content">
            <div class="tab-pane active" id="profile">
              ...
              <form>
                ...
                <div class="form-group">
                    <label for="fullName">Full Name</label>
                    <input type="text" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Email" value="Email of opened user">
                    <small id="emailHelp" class="form-text text-muted">Your email may appear around here where you are mentioned. You can change or remove it at any time.</small>
                </div>
